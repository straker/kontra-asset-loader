...
asyncTest('should load the image and resolve with it.', function() {
  ...
  kontra.loadImage('./imgs/bullet.gif').then(function(image) {
    ...
    ok(kontra.images['./imgs/bullet'], 'asset \'./imgs/bullet\' exists.');
    equal(kontra.images['./imgs/bullet'], image, 'asset \'./imgs/bullet\' is the correct image.');
